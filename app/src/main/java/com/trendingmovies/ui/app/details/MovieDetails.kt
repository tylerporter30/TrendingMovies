package com.trendingmovies.ui.app.details
...
import com.trendingmovies.utils.Constants
    ...
    Row(
        ...
        Image(
            modifier = Modifier
                .fillMaxWidth()
                .fillMaxHeight(),
            painter = rememberCoilPainter(request = Constants.BASE_IMAGE_URL + movieItem.backdrop_path),
            contentDescription = ""
        )
    }
}
